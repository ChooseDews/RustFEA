...
use crate::benchmarks::plotting::{format_material_properties, format_with_units};
...
fn run_block_validation(
    ...
    for &node_id in x_max_nodes
        .iter()
        .chain(y_max_nodes.iter())
        .chain(z_max_nodes.iter())
    {
    ...
    simulation
        .node_fields
        .insert("radial_displacement".to_string(), radial_disp);
    simulation
        .node_fields
